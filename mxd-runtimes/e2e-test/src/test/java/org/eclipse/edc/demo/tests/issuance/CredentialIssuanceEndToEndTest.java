...
public class CredentialIssuanceEndToEndTest {
    ...
    private static final String BOB_IDENTITYHUB_IDENTITY_URL = "http://127.0.0.1/bob-ih/cs";
    private static final String PARTICIPANT_CONTEXT_ID = "did:web:bob-ih%3A7083:bob";
    ...
    private static RequestSpecification baseRequest() {
        return given()
                .baseUri(BOB_IDENTITYHUB_IDENTITY_URL)
    ...
    void makeCredentialRequest_expectCredential() {
                ...
                .body("""
                        {
                          ...
                          "holderPid": "%s",
                          "credentials": [
                            {"format": "VC1_0_JWT", "credentialType": "NameCredential"}
                          ]
                        }
        ...
        assertThat(list).anySatisfy(typesList -> assertThat(typesList).containsExactlyInAnyOrder("NameCredential", "VerifiableCredential"));
